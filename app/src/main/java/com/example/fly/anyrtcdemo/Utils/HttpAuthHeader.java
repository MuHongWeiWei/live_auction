...
public class HttpAuthHeader {
    ...
    private void parseHeader(String header) {
    	Log.v("HttpHeader", "HttpAuthHeader.parseHeader(): header: " + header);
    ...
    private void parseParameters(String parameters) {
        Log.v("HttpHeader", "HttpAuthHeader.parseParameters():" +
    ...
    private void parseParameter(String parameter) {
        if (parameter != null) {
            ...
            if (i >= 0) {
                ...
                Log.v("HttpHeader", "HttpAuthHeader.parseParameter():" +
                        " token: " + token +
                        " value: " + value);
